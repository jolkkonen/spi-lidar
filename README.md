...
This repository contains files for the manuscript [Simulation of ultra-fast structured illumination in single-photon sensitive single-pixel lidar](https://doi.org/10.1364/opticaopen.27117139.v3) by Jaakko Olkkonen, Josef Taher, Teemu Hakala, Antero Kukko, Harri Kaartinen, and Juha Hyyppä.
